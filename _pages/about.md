...
During my Ph.D., I worked as a research intern at Tencent(focused on AIGC and talking face), NetEase Fuxi AI Lab(Norface: top-1 in multiple FER tasks, collaborated on DiffSFSR text-to-image generating 135 facial expressions), and Happy Elements(AI-assisted game content: 2D/3D virtual human expressions, 3D motion, and scene generation), where I had the opportunity to collaborate with [Yu Ding](https://scholar.google.com/citations?hl=zh-CN&user=T9Vd-rcAAAAJ&view_op=list_works&sortby=pubdate).
